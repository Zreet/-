...
class SetBasicInfo {
     ...
     */
    private static int getBox(String s, XMLInfo a, int state) throws SetInfoException {
        int bar;
        int box;
        switch (state) {
            case 11:// 星动单点/长条开始
     ...
     * @return 轨道数字
     */
    private static int idol2Int(String s, boolean is4k) throws SetInfoException {
        if (is4k) {
            switch (s) {
                case "Left2":
                    return 0;
    ...
    private static int pinball2Int(String s) throws SetInfoException {
        switch (s) {
            case "1":
            case "2":
            case "1|2":
    ...
    private static String idol2Str(int track) throws SetInfoException {
        switch (track) {
            case 0:
                return "一";
            case 1:
    ...
    private static String pinball2Str(int track) throws SetInfoException {
        switch (track) {
            case 0:
                return "左边";
            case 1:
